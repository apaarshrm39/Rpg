...
import (
	...
	v1alpha1 "github.com/apaarshrm39/rgp/pkg/client/informers/internalversion/v1alpha1"
...
type SharedInformerFactory interface {
	...
	Apaar() v1alpha1.Interface
}

func (f *sharedInformerFactory) Apaar() v1alpha1.Interface {
